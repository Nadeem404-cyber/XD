...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY NADEEM-XD \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/100023732631875')
        menu()
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/100023732631875')
        menu()
